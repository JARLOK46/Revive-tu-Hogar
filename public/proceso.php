...
<head>
  ...
  <title>Proceso - Revive tu Hogar</title>
...
<body>
  ...
  <header class="navbar">
    <div class="container navbar-inner">
      ...
      <nav class="nav-links">
        ...
        <a href="/proceso.php" class="badge">Proceso</a>
        <?php
  ...
  <main class="container section">
    <section class="hero-page">
      <h1 class="reveal-left">Nuestro proceso</h1>
      <p class="lead reveal-right" style="transition-delay:60ms">Trabajamos con metodologías claras y comunicación constante para que disfrutes el camino y el resultado.</p>
    </section>

    <section class="card reveal" style="margin-top:10px">
      <h2>Pasos clave</h2>
      <ol class="timeline">
        <li class="reveal-left">Diagnóstico: visitamos tu espacio y entendemos tus necesidades.</li>
        <li class="reveal-left" style="transition-delay:60ms">Propuesta: diseñamos un plan acorde a tu presupuesto.</li>
        <li class="reveal-left" style="transition-delay:120ms">Ejecución: coordinamos materiales y profesionales.</li>
        <li class="reveal-left" style="transition-delay:180ms">Entrega: control de calidad y cierre del proyecto.</li>
      </ol>
    </section>

    <section class="grid cards reveal stagger" style="margin-top:22px">
      ...
      <div class="card reveal-scale" data-3d>
        ...
        <p>Canales abiertos y un responsable de proyecto para resolver dudas en cada etapa.</p>
      </div>
    </section>

    <div class="cta-block glass reveal" style="margin-top:20px">
      <p>¿Listo para comenzar? Revisa los planes y agenda tu visita técnica.</p>
